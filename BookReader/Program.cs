...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (current != null)
        {
            ...
            for (int i = 0; i < content.Length; i += 90)
            {
                string line = content.Substring(i, Math.Min(90, content.Length - i));
                Console.WriteLine(line);
            }
            ...
            Console.Write(current.Next != null ? "[N] NEXT >".PadLeft(76) : string.Empty.PadLeft(76));
            Console.Write(GetSpaces(28) + "[X] EXIT"); // Add the exit option
            Console.WriteLine();
